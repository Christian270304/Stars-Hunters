...
const hypervelocidad = document.getElementById('hipervelocitat');
let moving = {
    up: false,
    down: false,
    left: false,
...
let config = { width: 0, height: 0, estrellas: {} };
let Players = {};
let estrellas = {};
let currentPlayerId;
...
socket.on('hyperspeedStatus', (data) => {
